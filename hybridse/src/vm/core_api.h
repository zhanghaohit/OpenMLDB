...
class CoreAPI {
 public:
    ...
    static ColumnSourceInfo ResolveSourceColumn(hybridse::vm::PhysicalOpNode* node, const std::string& db_name,
    ...
    static hybridse::codec::Row RowProject(const hybridse::vm::RawPtrHandle fn, const hybridse::codec::Row row,
                                           const hybridse::codec::Row parameter, const bool need_free = false);
    ...
    static bool ComputeCondition(const hybridse::vm::RawPtrHandle fn, const Row& row, const Row& parameter,
