...
base::Status ScheduleAggGenerators(std::unordered_map<std::string, AggColumnInfo>& agg_col_infos,  // NOLINT
...
base::Status AggregateIRBuilder::BuildMulti(const std::string& base_funcname, ExprIRBuilder* expr_ir_builder,
