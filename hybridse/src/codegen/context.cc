...
const codec::Schema* CodeGenContext::parameter_types() const { return parameter_types_; }
const codec::RowFormat& CodeGenContext::parameter_row_format() const { return parameter_row_format_; }
